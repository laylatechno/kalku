    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Kalkulating - {{ $subtitle }}</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge 
        @if($p->warna == 'success') bg-success
        @elseif($p->warna == 'warning') bg-warning
        @elseif($p->warna == 'danger') bg-danger
        @elseif($p->warna == 'primary') bg-primary
        @else bg-secondary
        @endif">
                                    {{ ucfirst($p->warna) }}
                                </span>
